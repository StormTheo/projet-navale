...
//    /**
//     * Test du constructeur par défaut pour l'initialisation (Plateau()) et la
//     * construction du plateau (constructPlateau()) par défaut
//     */
...
//    /**
//     * Test du constructeur pour l'initialisation à partir d'argument
...
//                        System.out.print("| " + v + "|"); // Rajout d'un espace avant le chiffre pour lisibilité du
//                                                          // plateau
//                    } else {
//                        System.out.print("|" + v + "|");
//                    }
...
//                    + " est considérée comme invalide" + " et doit afficher un tableau de 13*13");
//            plateau = jeu.constructPlateau();
//            /* Affichage du plateau */
//            for (int j = 0; j < plateau.length; j++) {
//                for (String v : plateau[j]) {
